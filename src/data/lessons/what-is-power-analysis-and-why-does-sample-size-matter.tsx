...
const LessonWhatIsPowerAnalysisAndWhyDoesSampleSizeMatter: Component = () => (
        ...
        >
          <div style="padding: 14px 16px; border: 2px solid; border-left: 4px solid; border-radius: 6px; margin: 0">
            ...
            <div style="font-size: 15px; line-height: 1.5">
              ...
              detectable effect (MDE), significance level (alpha, typically 5%),
              and power (typically 80%).
            </div>
          </div>
          ...
          <p style="margin-top: 0">
            ...
            . Halving the MDE quadruples required sample size. Increasing power
            from 80% to 90% adds ~30% more sample. These are expensive
            trade-offs.
          </p>
          <p>
            For a conversion experiment: baseline 5%, MDE 10% relative lift
            (detecting 5.5% vs 5.0%), alpha 5%, power 80% requires ~31,000 users
            per arm, or 62,000 total. At 10,000 daily users, thats 6-7 days
            minimum.
          </p>
          <p style="margin-top: 20px; margin-bottom: 6px; font-size: 13px; font-weight: 700; text-transform: uppercase; letter-spacing: 0.5px">
          ...
          <p style="margin-top: 0">
            Running underpowered experiments wastes resources. If true effect is
            3% but your MDE is 5%, you have only 30-40% chance of detecting it.
            Worse, any significant result from underpowered experiments is
          ...
          <p style="margin-top: 0">
            ...
            traffic to experiment surface, expected runtime. If runtime exceeds
            4-6 weeks, reconsider: accept larger MDE? Reduce metric variance?
            Use higher-traffic surface?
          </p>
        </div>
        <div
          class="card-diagram"
            ...
            <div style="display: flex; flex-direction: column; gap: 12px">
              ...
              <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 10px">
                ...
                <div style="border: 2px solid; padding: 10px; border-radius: 6px; text-align: center">
                  ...
                  <div style="font-size: 12px; margin-top: 4px">80% to 90%</div>
                </div>
              </div>
        ...
        <div class="Learn_keyTakeaways p-4 mb-4">
          ...
          <div class="d-flex flex-column gap-2">
            ...
            <div class="d-flex align-items-center Learn_keyTakeawaysItem">
              <span class="Learn_keyTakeawaysBullet me-3">✓</span>
              <span class="flex-grow-1 Learn_cardContent">
                Underpowered experiments suffer from winners curse - significant
                results are inflated estimates
              </span>
            </div>
            <div class="d-flex align-items-center Learn_keyTakeawaysItem">
              <span class="Learn_keyTakeawaysBullet me-3">✓</span>
              <span class="flex-grow-1 Learn_cardContent">
                High-variance metrics (revenue) need 4x+ sample vs low-variance
                metrics (conversion)
              </span>
            </div>
            <div class="d-flex align-items-center Learn_keyTakeawaysItem">
...
export default LessonWhatIsPowerAnalysisAndWhyDoesSampleSizeMatter;
