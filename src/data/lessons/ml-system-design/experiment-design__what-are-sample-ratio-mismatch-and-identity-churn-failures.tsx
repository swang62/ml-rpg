...
const LessonExperimentDesignWhatAreSampleRatioMismatchAndIdentityChurnFailures: Component =
  () => (
...
export default LessonExperimentDesignWhatAreSampleRatioMismatchAndIdentityChurnFailures;
