...
const LessonExperimentDesignWhatIsRandomizationAndStickyBucketingInExperiments: Component =
  () => (
...
export default LessonExperimentDesignWhatIsRandomizationAndStickyBucketingInExperiments;
