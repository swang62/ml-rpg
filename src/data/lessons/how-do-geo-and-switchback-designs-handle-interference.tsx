...
const LessonHowDoGeoAndSwitchbackDesignsHandleInterference: Component = () => (
      ...
      <div class="mb-4 p-4">
        ...
        >
          ...
          <p style="margin-top: 0">
            ...
            buyers get faster matching, they consume driver supply that control
            buyers would have used. User-level effects spill over, biasing your
            estimates.
          </p>
          <p>
            Social networks have similar issues: if treatment users share more,
            control users see more content. The control experience is
          ...
          <p style="margin-top: 0">
            Randomize entire cities or regions. Chicago gets treatment, Detroit
            gets control. All users in a region have same experience,
            eliminating within-region spillover. Trade-off: you need many
            regions for statistical power. With 50 cities, you have 25 units per
            arm - high variance.
          </p>
          <div style="padding: 12px; border-left: 4px solid; margin: 12px 0; border-radius: 4px">
            ...
            matched on pre-experiment trends. This reduces variance when region
            count is limited.
          </div>
          <p style="margin-top: 20px; margin-bottom: 6px; font-size: 13px; font-weight: 700; text-transform: uppercase; letter-spacing: 0.5px">
            Switchback Design
            ...
            <div style="display: flex; gap: 14px">
              <div style="flex: 1; display: flex; flex-direction: column; gap: 10px">
                ...
                <div style="border: 2px solid; padding: 10px; border-radius: 6px; text-align: center">
                  ...
                  <div style="font-size: 11px; margin-top: 4px">Treatment</div>
                </div>
                <div style="border: 2px solid; padding: 10px; border-radius: 6px; text-align: center">
          ...
          <div class="d-flex flex-column gap-2">
            <div class="d-flex align-items-center Learn_keyTakeawaysItem">
              ...
              <span class="flex-grow-1 Learn_cardContent">
                User-level randomization fails when treatment effects spill over
                to control users (marketplace, social)
              </span>
            </div>
            <div class="d-flex align-items-center Learn_keyTakeawaysItem">
              <span class="Learn_keyTakeawaysBullet me-3">✓</span>
            ...
            <div class="d-flex align-items-center Learn_keyTakeawaysItem">
              <span class="Learn_keyTakeawaysBullet me-3">✓</span>
              <span class="flex-grow-1 Learn_cardContent">
                Synthetic control matches treatment regions to weighted control
                combinations for variance reduction
              </span>
            </div>
            <div class="d-flex align-items-center Learn_keyTakeawaysItem">
              <span class="Learn_keyTakeawaysBullet me-3">✓</span>
        ...
        <div class="Learn_examplesSection p-4 mb-4">
          ...
          <div class="d-flex flex-column gap-2">
            ...
            <div class="d-flex align-items-center Learn_exampleItem">
              ...
              <span class="flex-grow-1 Learn_cardContent">
                For geo design: mention 50+ regions needed for power, synthetic
                control for limited regions
              </span>
            </div>
          </div>
        </div>
...
export default LessonHowDoGeoAndSwitchbackDesignsHandleInterference;
