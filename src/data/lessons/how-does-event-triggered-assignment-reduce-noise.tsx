...
const LessonHowDoesEventTriggeredAssignmentReduceNoise: Component = () => (
      ...
      <div class="mb-4 p-4">
        ...
        >
          ...
          <p style="margin-top: 0">
            Top-of-funnel assignment randomizes all users on first request. For
            a checkout experiment, this includes users who never browse
          ...
          <p>
            If only 5% of users reach checkout, you are measuring the treatment
            effect on 100% of users but only 5% could possibly be affected. The
            95% dilution multiplies your required sample size by roughly 20x.
          </p>
          <p style="margin-top: 20px; margin-bottom: 6px; font-size: 13px; font-weight: 700; text-transform: uppercase; letter-spacing: 0.5px">
          ...
          <p style="margin-top: 0">
            ...
            recommendation display. The trigger event should be the last moment
          ...
          <p style="margin-top: 0">
            ...
            assignment when measuring total business impact; use event-triggered
            when measuring feature-specific effects.
          </p>
        </div>
        <div
          class="card-diagram"
            ...
            <div style="display: flex; gap: 16px">
              <div style="flex: 1; display: flex; flex-direction: column; gap: 10px">
                ...
                <div style="border: 2px solid; padding: 10px; border-radius: 6px; text-align: center">
                  ...
                  <div style="font-size: 11px; margin-top: 4px">High noise</div>
                </div>
                <div style="font-size: 20px; font-weight: bold; text-align: center">
                  ↓
                </div>
              ...
              <div style="flex: 1; display: flex; flex-direction: column; gap: 10px">
                ...
                <div style="border: 2px solid; padding: 10px; border-radius: 6px; text-align: center">
                  <strong style="font-size: 12px">Randomize</strong>
                  <div style="font-size: 11px; margin-top: 4px">Low noise</div>
                </div>
                <div style="font-size: 20px; font-weight: bold; text-align: center">
                  ↓
                </div>
        ...
        <div class="Learn_keyTakeaways p-4 mb-4">
          ...
          <div class="d-flex flex-column gap-2">
            ...
            <div class="d-flex align-items-center Learn_keyTakeawaysItem">
              <span class="Learn_keyTakeawaysBullet me-3">✓</span>
              <span class="flex-grow-1 Learn_cardContent">
                Trigger at the last moment before treatment exposure to maximize
                signal
              </span>
            </div>
            <div class="d-flex align-items-center Learn_keyTakeawaysItem">
...
export default LessonHowDoesEventTriggeredAssignmentReduceNoise;
