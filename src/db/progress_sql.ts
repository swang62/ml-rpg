...
export async function getReadLessonsBySection(
  database: Database,
  args: GetReadLessonsBySectionArgs,
): Promise<GetReadLessonsBySectionRow[]> {
...
export async function isLessonRead(
  database: Database,
  args: IsLessonReadArgs,
): Promise<IsLessonReadRow | null> {
...
export async function getReadCountsByCourse(
  database: Database,
  args: GetReadCountsByCourseArgs,
): Promise<GetReadCountsByCourseRow[]> {
...
export async function getAllReadLessons(
  database: Database,
  args: GetAllReadLessonsArgs,
): Promise<GetAllReadLessonsRow[]> {
